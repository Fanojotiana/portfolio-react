  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 md:px-8 py-3 flex justify-between items-center">
       <motion.span
              className="inline-flex items-center px-5 py-0.5 text-xl font-pacifico text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full shadow-lg ring-2 ring-indigo-500/20"
              whileHover={{
                scale: 1.05,
